...
<body>
<div class="container">
    <%--    <form:form action="/dat-phong/add" modelAttribute="add" method="post">--%>
    ...
    <table class="table table-striped" border="1">
        ...
        <c:forEach items="${list}" var="dv">
            <tr>
                <td>${dv.ma_dat_phong}</td>
                <td>${dv.ngay_gio_dat}</td>
                <td>${dv.so_luong_khach }</td>
                <td>${dv.so_luong_phong_dat}</td>
                <td>${dv.loaiPhong.ma_khach_hang}</td>
                <td>${dv.loaiPhong.ten_khach_hang}</td>
                <td>
